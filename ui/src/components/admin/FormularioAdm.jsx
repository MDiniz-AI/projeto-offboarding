...
export default () => {
  ...
  return (
    <div>
      <div>
        <h1 className="text-primary font-title text-4xl text-center my-[2vh]">
          Formulário
        </h1>
        <div className="flex flex-row flex-wrap gap-[1vw]">
          <Squircle
            className="bg-secondary/30 md:w-[24vw] w-83 h-55 md:h-[27vh] px-[1.2vw] py-[1vh] flex-col"
            cornerRadius={20}
            cornerSmoothing={1}
          >
            ...
            <div className="flex flex-row gap-[2vw]">
              <div className="relative">
                <progress
                  class={`progress md:w-[10vw] w-39 h-[5vh] ${getBgClass(
                    objFormulario.valorScore
                  )}`}
                  value={objFormulario.valorScore * 100}
                  max="100"
                ></progress>
