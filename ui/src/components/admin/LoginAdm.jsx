...
export default () => {
    ...
    return (
        <div>
            ...
            <div className='md:top-3 md:left-3 md:w-[42vw] md:h-[97vh] absolute top-0 left-0 w-screen h-screen bg-base-100 flex md:flex-row flex-col gap-[2vw] md:gap-[1vw] pt-[4vh] justify-end'>
                <div className='hidden md:block md:w-full ml-[1vw]'>
                    <div className='flex'>
                        <Blip className="w-[4vw] h-auto" />
                    ...
                    <div className='bg-primary h-[.01vh] min-h-[.5px] w-[40vw] mt-[3vh] '/>
                        <form action="" className="mt-[3vh] flex flex-col md:gap-[32vh] gap-[29vh]">
                            ...
                            <button onClick={{}} className='flex md:gap-[31vw] gap-[60vw] bg-accent md:p-[1vw] p-[3vw] rounded-xl w-[97vw] md:w-[40vw] mx-auto md:mx-0 mb-[1vh] md:mb-0 md:mt-0 mt-[1vh]'>
