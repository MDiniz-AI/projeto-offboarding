            ...
            <div className='absolute top-3 left-3 w-[53vw] h-[97vh] bg-base-100 flex gap-[2vw] pt-[4vh]'>
                <div className='flex flex-col gap-[12vh]'>
                    ...
                    <div className='flex flex-col gap-[1vh] ml-[2vw]'>
                        ...
                        <div className={props.idPag == 1 ? ativo : inativo}><AtIcon size="4vh" weight="thin" className='text-primary' /></div>
                        <div className={props.idPag == 2 ? ativo : inativo}><TargetIcon size="4vh" weight="thin" className='text-primary' /></div>
                        <div className={props.idPag == 3 ? ativo : inativo}><UsersThreeIcon size="4vh" weight="thin" className='text-primary' /></div>
                ...
                <div className='bg-primary w-[.01vw] min-w-[.5px] h-[90vh] '></div>
                {props.codigo}
            </div>
        </div>
    )
