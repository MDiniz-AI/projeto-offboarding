...
export default () => {
    ...
    const html = <div className='flex flex-col gap-[4vh] justify-center mt-[-4vh]'>
            <h1 className="font-title text-[3.5vw] text-primary mx-auto">{tipoErro == 1 ? erroAcesso[0] : tipoErro == 2 ? erroRespondido[0] : erroNaoEncontrado[0]}</h1>
            <p className="font-corpo w-[40vw] text-[1vw] text-center text-primary mx-auto mt-[-4vh]">{tipoErro == 1 ? erroAcesso[1] : tipoErro == 2 ? erroRespondido[1] : erroNaoEncontrado[1]}</p>
